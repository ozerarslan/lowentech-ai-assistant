module.exports = async (req, res) => {
    ...
    try {
        ...
        const maxLength = 4500; // API limitlerine karşı güvenlik önlemi
        ...
        if (!response.ok) {
            ...
            throw new Error(`Google TTS API hatası: ${errorData.error?.message || 'Bilinmeyen Hata'}`);
        }
        ...
        // Hata durumunda, frontend'e tarayıcı TTS'e geçmesini söyleyen bir bayrak gönder
        res.status(500).json({ 
